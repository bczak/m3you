...
// m3you fork: FAB is a real component whose all-caps name trips the
// object-constant heuristic — exempt it before the ALL-CAPS test.
export const isComponentName = (n) => n === 'FAB' || (!n.endsWith('Props') && !/^[A-Z][A-Z0-9_]+$/.test(n)
