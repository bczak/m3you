...
const NavigationBar = React.forwardRef<HTMLElement, React.PropsWithoutRef<NavigationBarProps>>(
  ({ className, orientation = 'vertical', value, onValueChange, children, ...props }, ref) => {
...
const NavigationBarItem = React.forwardRef<HTMLButtonElement, React.PropsWithoutRef<NavigationBarItemProps>>(
  (
    {
      className,
      value,
      ...
      >
        {orientation === 'vertical' ? (
          ...
          <>
            ...
            <span
              className="md-navigation-bar-item__indicator--horizontal"
              data-active={isActive ? 'true' : undefined}
            />
