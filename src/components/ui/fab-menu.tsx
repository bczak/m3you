...
const FABMenu = React.forwardRef<HTMLDivElement, FABMenuProps>(
  ({ open: controlledOpen, defaultOpen = false, onOpenChange, scrim = false, className, children, ...props }, ref) => {
...
const FABMenuTrigger = React.forwardRef<HTMLButtonElement, FABMenuTriggerProps>(
  (
    { icon, closeIcon, asChild = false, children, className, onClick, size = 'md', shape = 'square', ...props },
    ref,
  ) => {
...
const FABMenuContent = React.forwardRef<HTMLDivElement, FABMenuContentProps>(
...
const FABMenuItem = React.forwardRef<HTMLButtonElement, FABMenuItemProps>(
  (
    { className, variant = 'tonal', shape = 'round', size = 'md', closeOnClick = true, onClick, children, ...props },
    ref,
  ) => {
